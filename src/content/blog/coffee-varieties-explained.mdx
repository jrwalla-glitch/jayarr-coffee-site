  ...
  items={[
    {
      ...
      description: "The sweet, complex foundation. Bourbon branches into: Caturra (dwarf mutation, Brazil) · SL28 (Kenya selection, exceptional quality) · Pacas (El Salvador mutation) · Villa Sarchi (Costa Rica mutation) · Tekisic (El Salvador improved selection) · K7 (Kenya, some rust tolerance) — all independent mutations or selections from Bourbon",
