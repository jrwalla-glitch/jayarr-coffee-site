...
The Q-grader exam spans approximately three days and includes 22 individual tests:
...
<FAQ items={[
  ...
  },
  {
    ...
    answer: "A Q-grader is a coffee professional licensed by the Coffee Quality Institute (CQI) to evaluate and score coffee using the SCA protocol. Certification requires passing 22 tests over roughly three days, covering triangulation (identifying the odd cup among three), sensory threshold detection, organic acid identification, roast-level evaluation, and full cupping assessments. About 80% of candidates fail on their first attempt. There are approximately 4,000 active Q-graders worldwide, and they must recalibrate every three years to maintain their license."
  },
  {
