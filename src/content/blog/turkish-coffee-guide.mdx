...
<RecipeSchema
  ...
  description="The world's oldest brewing method done right. Ultra-fine grounds simmered in a cezve with sugar, producing a thick, intensely flavored cup with signature foam."
  prepTime="PT1M"
  cookTime="PT3M"
  totalTime="PT4M"
  ...
  recipeIngredient={[
    "7-10g extra-fine ground coffee (finer than espresso, almost powder)",
    "65-75ml cold filtered water",
    "1 tsp sugar (adjust to taste: sade/none, az sekerli/half, orta/one, sekerli/two)",
    "1 cracked cardamom pod or pinch of ground cardamom (optional)"
  ]}
  recipeInstructions={[
    "Add cold water to the cezve, then coffee, then sugar. Stir briefly to wet the grounds.",
    "Place the cezve on the smallest burner at medium-low heat. Do not stir after placing on heat.",
    "Watch the surface as the coffee heats over 2-3 minutes. A dark foam will form on the surface.",
    "When the foam rises toward the rim of the cezve, remove from heat immediately. Do not let it boil over.",
    "Spoon foam into each cup first, then pour the coffee slowly. Do not pour the last few drops.",
    "Wait 60-90 seconds for the grounds to settle before drinking. Stop when you reach the thick sediment at the bottom."
  ]}
  nutrition={{
    calories: "21 calories",
    servingSize: "1 demitasse (2.5 oz)",
    fatContent: "0 g",
...
<HowToSchema
  name="How to Make Turkish Coffee"
  description="The traditional method for brewing Turkish coffee in a cezve (ibrik) — 500 years of technique, done right."
  steps={[
    { name: "Combine cold water, coffee, and sugar in the cezve", text: "Add 60-70ml of cold water per cup, 7-10g of extra-fine ground coffee (finer than espresso — almost powder), and sugar to taste. Stir to combine before heating." },
    { name: "Heat slowly on low flame", text: "Place the cezve on the lowest heat setting. Slow heating is critical — it allows proper extraction and foam development. Do not stir after placing on heat." },
    { name: "Watch for the foam to rise", text: "As the coffee heats, a dark foam will form on the surface. When the foam rises toward the rim of the cezve, remove from heat immediately. Do not let it boil over." },
    { name: "Pour and serve with grounds", text: "Pour slowly into small cups (fincan), distributing the foam evenly. The grounds go in the cup — they settle to the bottom as you drink. Do not filter." },
    { name: "Wait 1-2 minutes before drinking", text: "Let the grounds settle to the bottom of the cup. Drink slowly — stop when you reach the thick sediment at the bottom. Serve with a glass of water." }
  ]}
  totalTime="PT4M"
/>
