...
If you don't own an espresso machine with a steam wand, a separate frother handles the foaming step — but most of them can't pour latte art. The category map (handheld, manual, electric jug, mesh-aeration, stovetop pressure) and the only sub-$200 tool that actually produces microfoam are in [best milk frothers for home baristas](/blog/best-milk-frothers-home-baristas/).
