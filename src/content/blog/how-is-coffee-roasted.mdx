...
Just about anything capable of producing consistent heat can be used. Everyday ovens or woks will work in a pinch, though controlling the process is difficult. **Heat guns** or modified popcorn machines generally produce better results by providing more even, controllable heat. The best outcomes come from dedicated **[home roasting machines](https://www.amazon.com/s?k=home+coffee+roasting+machine&tag=jayarrcoffee-20)**, which let you monitor temperature and time while automating the cooling cycle.
