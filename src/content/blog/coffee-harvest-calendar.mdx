...
<HarvestCalendar
  ...
  origins={[
    ...
    { name: "Kenya (fly crop)", group: "Africa", harvest: [6, 7, 8], arrival: [9, 10] },
  ...
  footnote="With careful sourcing and rotation, you can keep most cups within peak crop-year freshness — though storage, freezing, and origin availability all play a role too."
/>
...
**Kenya** (October–December main / June–August fly crop)
Kenya's main harvest runs October through December, with a smaller secondary "fly crop" mid-year (typically June through August, with some regions picking as early as April). The country's meticulous wet-processing and weekly auction system add time, but quality control is exceptional. Fresh main-crop arrivals typically land February–April. The smaller mid-year harvest arrives August–October. Peak buying window: **March–June** (main crop). For more on what makes Kenyan coffee special, see our [Kenyan coffee flavor guide](/blog/ethiopian-coffee-flavors-and-varieties/).
...
The key insight: with careful sourcing, you rarely *need* to drink obviously past-crop coffee. By rotating origins with the seasons, most bags you buy can land within or close to their peak freshness window. Frozen reserves of a favorite origin and good roaster sourcing fill in the gaps when an origin is between harvests.
