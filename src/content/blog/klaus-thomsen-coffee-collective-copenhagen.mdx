...
The annual transparency report names every farm, lists the FOB price paid, the green cost-per-kilo, the volume purchased, and the years the relationship has been in place. **Kieni** appears on every report. So does **Daterra** in Brazil's Cerrado, **Kerinci** in Indonesia, and a rotating cast of producers in Ethiopia, Colombia, and Honduras. The report is dry, technical, and — by the standards of food-industry sustainability marketing — almost subversively honest. When prices fall at origin, the report says so. When a relationship ends, it says why.

That document became a category-defining piece of writing. By the late 2010s, dozens of specialty roasters in Europe and North America were publishing their own annual transparency reports, almost all of them visibly modeled on Coffee Collective's template. Counter Culture's, Tim Wendelboe's, and the Crown's reports cite the format directly. Coffee Collective signed the industry-wide [Transparency Pledge](https://www.transparency.coffee/) in 2019, but had effectively been writing the pledge for a decade before it existed.
...
Wallgren has since moved into a hybrid role at Coffee Collective; recent [Barista Magazine](https://www.baristamagazine.com/10-minutes-2016-world-brewers-cup-runner-mikaela-wallgren/) coverage describes her as both a brewer and an HR coordinator at the company — exactly the kind of in-house career progression Hoffmann's podcast was hunting for evidence of.
