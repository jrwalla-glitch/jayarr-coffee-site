...
<ComparisonTable
  ...
  rows={[
    { name: "Hario Drip Scale", values: ["$40–50", "0.1g", "Yes", "Built-in brew timer"], result: "Best Performance" },
    { name: "Airo Style", values: ["~$25", "0.1g", "Yes", "Stainless steel platform"], result: "Best Overall" },
    { name: "Ozeri Touch", values: ["~$15", "1g", "No", "Tempered glass design"], result: "Most Stylish" },
    { name: "Apexstone", values: ["~$15", "0.1g", "Yes", "Multiple units"], result: "Budget Pick" },
    { name: "Etekcity", values: ["~$10", "1g", "No", "Ultra-portable"], result: "Best Value" }
  ]}
/>
