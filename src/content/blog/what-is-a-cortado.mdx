...
<RecipeSchema
  title="Cortado"
  description="Espresso cut with an equal measure of steamed milk. No foam, no flavoring — just two ingredients in perfect balance. The espresso drink that reveals quality."
  videoId="ljK8fX5DlEU"
  prepTime="PT2M"
  cookTime="PT1M"
  totalTime="PT3M"
  ...
  recipeInstructions={[
    "Pull a double shot of espresso (about 2 oz) into a small glass.",
    "Steam 2 oz of milk to 150-155°F with minimal foam — think microfoam, not cappuccino froth.",
    "Pour steamed milk slowly into the espresso, letting them integrate into a single cohesive beverage.",
    "Serve immediately in a 4 oz glass."
  ]}
  nutrition={{
    calories: "23 calories",
    servingSize: "1 cortado (4 oz)",
    fatContent: "1 g",
    saturatedFatContent: "0.6 g",
    carbohydrateContent: "1.5 g",
    sugarContent: "1.5 g",
    proteinContent: "1 g",
    sodiumContent: "15 mg",
  }}
