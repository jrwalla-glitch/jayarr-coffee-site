...
<iframe width="100%" style={{aspectRatio:"16/9"}} src="https://www.youtube.com/embed/n289-PKF0lo" title="Coffee Extraction Explained — Why Your Coffee Tastes Wrong" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
...
<ComparisonTable
  ...
  rows={[
    ...
    { name: "Espresso", values: ["8–13%", "Roughly 10x filter concentration"] },
...
<DeepBrewCallout tool="extraction" context="Use the TDS and extraction yield sliders to pinpoint which quadrant you're in — and get the exact fix for your brew method." />
