...
If you're ready to taste the difference varietals make, an excellent starting point is a [high-quality single-origin Ethiopian or Kenyan](https://www.amazon.com/s?k=single+origin+specialty+coffee+SL28+Ethiopian&tag=jayarrcoffee-20) — two origins where the variety-terroir combination is most distinct and recognizable. Pair it with attention to your [grind size](/blog/coffee-grind-size-guide-what-grind-for-every-brew-method/) and [brew temperature](/blog/whats-the-ideal-coffee-brewing-temperature/) to give the genetics every chance to show themselves.
