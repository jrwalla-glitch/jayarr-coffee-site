...
<AnswerBox answer="The cities most consistently cited in specialty coffee writing as the centers of the modern third-wave conversation are Melbourne, Tokyo, Oslo, Stockholm, Copenhagen, Berlin, London, Portland, Seattle, San Francisco, New York, and Seoul. Each anchored a distinctive style — Nordic light roast, Antipodean espresso, Japanese hand-drip, American third wave — and most still hold that lineage in their best roasters today." />
...
- Oslo's Tim Wendelboe (founded 2007) is one of the most globally influential single roasteries of the past two decades — its house style defined what most people now mean by "Nordic light roast."
...
<CoffeeCityCards
  ...
  cities={[
    ...
    },
    {
      ...
      wave: "fourth",
      note: "South Korea is widely cited as having one of the world's densest cafe cultures.",
    },
  ]}
  stats={[
