...
**Strength = TDS%** — how concentrated your brewed coffee is. How much dissolved material is in the cup. A good filter coffee lands around 1.15-1.45% TDS. Espresso is dramatically higher: 8-12% TDS.
...
In 2023, Guinard's research at UC Davis updated the chart based on modern consumer preference testing. The new preferred range: **19-24% extraction yield, 1.1-1.3% TDS**. Two notable findings from that study: the ideal extraction window is wider than the original chart suggests, and TDS has a bigger effect on consumer preference than extraction yield alone. People are more sensitive to how strong their coffee is than to subtle differences in extraction completeness.
...
<FAQ items={[
  { question: "What is a good coffee extraction yield?", answer: "The SCA standard is 18-22%, though UC Davis research (Guinard, 2023) found consumer preference extends to 19-24%. The 'right' number depends on your coffee, roast level, and grinder quality. A uniform grinder can produce excellent cups above 22%, while a grinder with lots of fines and boulders can taste muddled at 20%. Use the range as a starting point, not a hard rule." },
