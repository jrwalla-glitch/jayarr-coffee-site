...
**What the microbes are doing:** Yeasts and bacteria consume the sugars in coffee mucilage (glucose, fructose, sucrose) and produce organic acids, alcohols, esters, and CO2 as metabolic byproducts. Those byproducts penetrate the parchment and the bean, creating flavor precursors that survive roasting. Cacao undergoes <a href="https://jayarrchocolate.com/blog/cacao-fermentation-science/" target="_blank" rel="noopener">an even more extended version of this microbial fermentation</a> — five to seven days versus coffee's 12–96 hours — and the same yeast-to-LAB succession determines whether the chocolate will be worth eating.
