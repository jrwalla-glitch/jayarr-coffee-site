...
The word means "stained" in Italian. A traditional [macchiato](/blog/what-is-a-macchiato/) is an espresso with just a small dollop of steamed milk foam on top — maybe two tablespoons. It softens the espresso's edges without hiding them. This is a very different drink from the caramel macchiato at chain coffee shops, which is essentially a flavored latte. There is also a third drink — the *latte macchiato* — that inverts the recipe (milk first, espresso poured through the foam); our [full macchiato guide](/blog/what-is-a-macchiato/) covers all three.
