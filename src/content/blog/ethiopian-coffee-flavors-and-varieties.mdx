...
<RegionCards
  ...
  stats={[
    { value: "11.6M", label: "Bags / Year" },
    { value: "15,000+", label: "Arabica Varieties" },
    { value: "~32%", label: "Consumed Domestic" },
...
Ethiopian coffee culture runs deeper than anywhere else on earth. Ethiopians consume close to a third of the country's coffee production domestically (USDA FAS forecasts 3.7M bags of domestic consumption against 11.6M bags total in MY 2025/26) — coffee isn't just an export crop, it's woven into daily life.
