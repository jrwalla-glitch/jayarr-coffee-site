...
<iframe width="100%" style={{aspectRatio:"16/9"}} src="https://www.youtube.com/embed/lSZpAHjk_NQ" title="Coffee Scoring Explained — The 100-Point System Is Changing" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen />
...
<ComparisonTable
  ...
  rows={[
    ...
    { name: "Extrinsic Value", values: ["Not captured", "Standard 105: origin, certifications, story"] },
    { name: "Languages", values: ["English only", "Seven languages"] },
    { name: "Bias Mitigation", values: ["None", "Descriptive assessment decoupled from preference"] }
  ]}
