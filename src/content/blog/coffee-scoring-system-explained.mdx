...
<ComparisonTable
  ...
  rows={[
    { name: "Output", values: ["Single 0-100 score", "Four-dimensional profile"] },
    { name: "Description vs. Preference", values: ["Combined into one number", "Separated (Std 103 + 104)"] },
    { name: "Extrinsic Value", values: ["Not captured", "New: origin, certs, story (Std 105)"] },
