...
<ComparisonTable
  ...
  rowLabel="Dimension"
  columns={["Old System", "New CVA"]}
  rows={[
    { name: "Output", values: ["Single 0-100 score", "4-dimensional profile"] },
    { name: "Desc. vs. Preference", values: ["Combined", "Separated (Std 103 + 104)"] },
    { name: "Extrinsic Value", values: ["Not captured", "Origin, certs, story (Std 105)"] },
    { name: "Languages", values: ["English only", "7 languages"] },
    { name: "Bias Mitigation", values: ["None", "Desc. decoupled from preference"] }
  ]}
