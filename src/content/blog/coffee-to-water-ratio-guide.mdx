...
Same range as filter, but the metal mesh filter passes oils that paper traps. This makes [French press](/blog/how-to-use-a-french-press-the-most-amazing-coffee-youve-ever-had/) taste fuller at the same ratio. Hoffmann's widely-used French press recipe calls for 75g per liter (1:13.3) — a notably stronger ratio than filter methods, reflecting his preference for a more full-bodied immersion brew. Start at 1:16 and adjust downward if you want something richer — French press is very forgiving of ratio tweaks because immersion brewing naturally resists overextraction.
