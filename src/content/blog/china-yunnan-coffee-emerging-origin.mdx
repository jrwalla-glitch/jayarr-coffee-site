...
If you're curious about tasting the difference, brew a [Yunnan specialty lot](https://www.amazon.com/s?k=Yunnan+single+origin+coffee&tag=jayarrcoffee-20) as a [pour-over](/blog/ultimate-pour-over-coffee-guide-and-best-v60-technique/) with a [medium-fine grind](/blog/coffee-grind-size-guide-what-grind-for-every-brew-method/) to let the terroir speak.
