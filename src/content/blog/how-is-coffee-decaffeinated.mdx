...
description: "Ever wondered how caffeine is removed from coffee beans? We break down the three main decaffeination methods — Swiss Water, solvent-based, and CO2 — and what each means for flavor."
pubDate: "Dec 15 2019"
...
<iframe width="100%" style="aspect-ratio:16/9" src="https://www.youtube.com/embed/0akAdI-6TbI" title="How Is Coffee Decaffeinated?" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
1. Flavor extracts and caffeine are stripped out of an initial batch of beans after a steam and water soak. This first batch is discarded.
2. The water — now containing both caffeine and flavor compounds — is passed through a **carbon filter** that removes only the caffeine. What remains is a caffeine-free, flavor-rich extract solution.
3. This extract is used to soak a new batch of beans. Because of solubility principles, caffeine migrates from the beans (high concentration) into the extract (low concentration), while the flavor compounds remain in the beans.
