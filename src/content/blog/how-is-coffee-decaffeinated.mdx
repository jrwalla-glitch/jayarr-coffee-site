  ...
  methods={[
    {
      ...
      metrics: [
        { label: "Caffeine Removed", value: "94–96%" },
...
2. The water — now containing both caffeine and flavor molecules — is passed through a carbon filter that removes only the caffeine (caffeine molecules are larger than most flavor compounds). What remains is a caffeine-free, flavor-saturated solution called Green Coffee Extract (GCE).
...
**Caffeine removal:** 94-96%. The FDA requires at least 97% removal for the "decaffeinated" label, and Swiss Water consistently hits this.
...
**What's in a cup of decaf:** Roughly 2-15 mg of caffeine per 8-ounce cup, compared to 95-200 mg in regular coffee. For most people, that residual amount is imperceptible.
...
<FAQ items={[
  { question: "Does decaf coffee have zero caffeine?", answer: "No. Decaf contains roughly 2-15 mg of caffeine per 8-ounce cup, compared to 95-200 mg in regular coffee. The FDA requires at least 97% caffeine removal for the 'decaffeinated' label, but that last 3% stays." },
  { question: "Is decaf coffee safe during pregnancy?", answer: "Most medical guidelines suggest limiting caffeine to 200 mg per day during pregnancy. A cup of decaf at 2-15 mg is well within that limit. The bigger consideration is the decaffeination method — Swiss Water and CO2 use no chemical solvents, which some expectant parents prefer." },
