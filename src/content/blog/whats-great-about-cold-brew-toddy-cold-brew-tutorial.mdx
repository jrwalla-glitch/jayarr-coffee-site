...
<RecipeSchema
  title="Cold Brew Coffee (Toddy System)"
  description="Smooth, sweet cold brew concentrate using the Toddy system's dual filtration. Coarse grounds steep for 14-16 hours, producing a clean concentrate that lasts up to two weeks refrigerated."
  videoId="60YOhhNMDsc"
  prepTime="PT10M"
  cookTime="PT16H"
  totalTime="PT16H"
  ...
  recipeIngredient={[
    ...
    "1,680ml (7 cups) cold filtered water",
    "Toddy brewing system (container, felt filter, paper filter, glass decanter)"
  ]}
  recipeInstructions={[
    "Grind 340g of coffee to a coarse grind, like coarse sea salt.",
    "Insert the rubber plug into the bottom of the Toddy container. Dampen the felt filter and place it in the bottom.",
    "Place the paper filter bag inside the container on top of the felt filter. Pour the ground coffee into the bag and distribute evenly.",
    "Pour 1,680ml of filtered water over the grounds. Stir gently to ensure all grounds contact water.",
    "Twist the top of the paper bag closed. Leave at room temperature or in the refrigerator for 14-16 hours.",
    "Position the brewing container over the glass decanter. Release the rubber stopper and let gravity drain the concentrate.",
    "Store concentrate in the refrigerator. Dilute 1:1 to 1:3 with water or milk when serving over ice."
  ]}
  nutrition={{
    calories: "5 calories",
...
<HowToSchema
  ...
  description="A simple cold brew method using coarse grounds and room-temperature or refrigerator steeping for a smooth, sweet concentrate."
  steps={[
    { name: "Grind coffee coarse", text: "Use a very coarse grind — like raw sugar or coarser. Fine grinds will over-extract during the long steep and produce bitter, muddy cold brew." },
    { name: "Combine coffee and cold water at 1:8 ratio", text: "Use 1 gram of coffee per 8 grams of water for a concentrate. For a standard batch: 100g coffee to 800g water. Room temperature or cold water both work." },
    { name: "Steep for 16-24 hours", text: "Cover and steep at room temperature (faster, slightly more body) or in the refrigerator (slower, cleaner). 18-20 hours is the sweet spot for most setups." },
    { name: "Filter through paper or cloth", text: "Strain through a fine mesh, then filter through paper or a cloth filter for a clean concentrate. The Toddy system handles this in one step." },
    { name: "Dilute and serve", text: "Cold brew concentrate is strong. Dilute 1:1 with water or milk over ice. Adjust ratio to taste. Concentrate keeps in the fridge for 7-10 days." }
  ]}
  totalTime="PT24H"
/>
