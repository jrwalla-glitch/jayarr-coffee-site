...
The **[Toddy Cold Brew System](https://www.amazon.com/s?k=Toddy+Cold+Brew+System&tag=jayarrcoffee-20)** is purpose-built for immersion cold brew, and it earns its reputation through one key feature: dual filtration. A felt filter catches large particles while a paper filter catches fine sediment. The result is noticeably cleaner and silkier than mason jar or French press cold brew.
