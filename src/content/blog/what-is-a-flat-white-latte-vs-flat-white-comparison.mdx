...
<RecipeSchema
  title="Flat White"
  description="A coffee-forward milk drink with ristretto shots and velvety microfoam. Smaller and more intense than a latte, smoother than a cappuccino."
  videoId="tH0HaX3zMKk"
  prepTime="PT2M"
  cookTime="PT2M"
  totalTime="PT4M"
  ...
  recipeIngredient={[
    "18g finely ground coffee for a double ristretto",
    "4 oz whole milk (cold from the fridge)"
  ]}
  recipeInstructions={[
    "Grind 18g of coffee, dose into portafilter, and tamp evenly.",
    "Pull a ristretto: same dose, shorter time (about 20-25 seconds for about 40ml double).",
    "Steam 4 oz of milk using the stretch-then-roll technique: 3-4 seconds near the surface for air, then angle deeper for 8-10 seconds to create a whirlpool. Heat to 65-70°C (150-158°F).",
    "Tap the pitcher firmly on the counter to pop surface bubbles, then swirl until the milk looks like glossy wet paint.",
    "Pour from 2 inches above the cup, aiming for the center. Halfway through, bring the pitcher closer for the microfoam integration.",
    "Serve immediately in a 5-6 oz cup."
  ]}
  nutrition={{
    calories: "41 calories",
    servingSize: "1 flat white (6 oz)",
    fatContent: "2 g",
