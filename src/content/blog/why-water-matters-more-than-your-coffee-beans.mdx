...
**Step 1: Test your water.** Get a <a href="https://www.amazon.com/s?k=TDS+meter+water&tag=jayarrcoffee-20" rel="sponsored noopener">TDS meter</a> (about $10) and a GH/KH test kit (about $8, sold at aquarium stores as the API GH/KH kit). Takes 30 seconds.
...
For everyone else, a **<a href="https://www.amazon.com/s?k=BWT+water+filter+pitcher+magnesium&tag=jayarrcoffee-20" rel="sponsored noopener">BWT pitcher with a magnesium cartridge</a>** ($40) handles chlorine, reduces hardness, and adds the mineral that matters most for flavor. It won't get you to competition water, but it'll get you 80% of the way there.
...
Once your water is dialed in, the next variables to address are [brew temperature](/blog/whats-the-ideal-coffee-brewing-temperature/) and [grind size](/blog/coffee-grind-size-guide-what-grind-for-every-brew-method/) — the three pillars of extraction working together. If you're curious <a href="https://jayarr.pizza/blog/water-for-pizza-dough/" target="_blank" rel="noopener">whether water chemistry matters as much for pizza dough</a> — it does, though the variables that matter most are different.

<DeepBrewCallout tool="water" context="Test your water's hardness and alkalinity against 10 named recipes. Get exact mineral concentrate instructions for your target profile." />
