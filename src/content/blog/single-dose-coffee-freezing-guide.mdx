...
**Best: Vacuum sealer.** A basic [FoodSaver-style vacuum sealer](https://www.amazon.com/s?k=FoodSaver+vacuum+sealer&tag=jayarrcoffee-20) ($30-50) with vacuum bags is the gold standard. It removes virtually all air from around the beans. This is what competition baristas use. If you're serious about coffee and plan to freeze regularly, this is the single best investment.

**Good: Small mason jars.** [4oz mason jars](https://www.amazon.com/s?k=4oz+mason+jars&tag=jayarrcoffee-20), filled to the brim to minimize headspace, sealed tightly. Not as effective as vacuum sealing, but a meaningful step up from bags. The key is minimizing the air pocket above the beans — fill to the top.
...
A [vacuum sealer with bags](https://www.amazon.com/s?k=food+vacuum+sealer+bags+coffee&tag=jayarrcoffee-20) is the single most useful investment for this protocol — a basic FoodSaver runs $30-50 and pays for itself the first time you save a bag of something exceptional.
