...
You can find [Peruvian organic coffee on Amazon](https://www.amazon.com/s?k=Peru+single+origin+coffee+organic&tag=jayarrcoffee-20) -- look for bags that name the region (Chanchamayo, Cajamarca) and list a roast date.
