...
export const origins: CoffeeOrigin[] = [
  ...
  },
  {
    id: 'vietnam',
    name: 'Vietnam',
    regions: ['Dak Lak (Central Highlands)', 'Lam Dong (Dalat)', 'Gia Lai & Kon Tum', 'Son La & Dien Bien (Northwest)'],
    production: '~30M bags',
    worldRank: 2,
    mainVarieties: ['Robusta (TR4, TR9, TR11)', 'Catimor (Arabica)'],
    primaryProcessing: ['Natural', 'Washed'],
    harvestMonths: [10, 3],
    altitudeRange: [400, 1500],
    flavorProfile: ['Dark Chocolate', 'Peanut', 'Earthy', 'Heavy Body', 'Citrus (Dalat Arabica)'],
    description: 'The world\'s second-largest coffee producer — and barely grew coffee before the 1990s. Vietnam\'s explosive Robusta production reshaped global coffee economics. Today, a specialty movement is emerging: Dalat\'s high-altitude Arabica and Fine Robusta are earning international recognition.',
    continent: 'asia',
    articles: [
      { slug: 'vietnam-coffee-origin-guide', title: 'Vietnam Coffee: How One Country Changed the Global Market' },
      { slug: 'vietnamese-phin-guide', title: 'Vietnamese Phin Guide: Brewing Method' },
    ],
  },
  {
    id: 'papua-new-guinea',
